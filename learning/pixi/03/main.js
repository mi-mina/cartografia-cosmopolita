// goodboy example: https://www.goodboydigital.com/pixijs/examples/5/
// To analize how many points can be animated at the same time before it gets slow
// Max shoud be more between 30000 and 40000
...
function start() {
  var ballTexture = new PIXI.Texture.fromImage("pixel1.png");
  ...
  switch (t) {
    ...
    case 6:
      for (var i = 0; i < n; i++) {
        xd = -90 + Math.round(Math.random() * 180);
        points1[i] =
          Math.cos((i * 360) / n) * 10 * (Math.cos((i * 360) / n) * 10);
        points2[i] = Math.cos((i * 360) / n) * 10 * (Math.sin(xd) * 10);
        points3[i] = Math.sin((i * 360) / n) * 100;
      }
      break;
    ...
    case 7:
      for (var i = 0; i < n; i++) {
        ...
        points1[i] =
          Math.cos((i * 360) / n) * 10 * (Math.cos((i * 360) / n) * 10);
        points2[i] =
          Math.cos((i * 360) / n) * 10 * (Math.sin((i * 360) / n) * 10);
        points3[i] = Math.sin((i * 360) / n) * 100;
      }
      break;
